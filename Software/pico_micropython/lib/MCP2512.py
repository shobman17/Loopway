...
# This is for the 16 MHz crystal
# CAN_RATE = {
...
# This is for the 8 MHz crystal
CAN_RATE = {
	"5KBPS"   : [0x1F, 0XBF, 0x87],
	"10KBPS"  : [0x0F, 0XBF, 0X87],
	"20KBPS"  : [0x07, 0XBF, 0x87],
	"50KBPS"  : [0x03, 0XB4, 0x86],
	"100KBPS" : [0x01, 0xB4, 0x86],
	"125KBPS" : [0x01, 0xB1, 0x85],
	"250KBPS" : [0x00, 0xB1, 0x85],
	"500KBPS" : [0x00, 0x90, 0x82],
	#"800KBPS" : [0x00, 0x92, 0x02],
	"1000KBPS": [0x00, 0x80, 0x80],
}
...
# 		self.cs = Pin(SPI0_CS0,Pin.OUT)
    ...
    def Init(self, speed="125KBPS"):
		...
		self.WriteBytes(CANCTRL, REQOP_CONFIG) # Set MCP2515 to config mode
